    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.ProductName.includes('Current')).filter(name => name.category.includes('Bank')).filter(name => name.country.includes('united states')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
...
export default DropsUSACurrent
