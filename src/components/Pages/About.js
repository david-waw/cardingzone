...
export default function About() {
  return (
    <>
      ...
      <p><span>We are<strong> CardingBird Vendor</strong>&nbsp;based somewhere in Utah <strong>from Hansa Marketplace</strong>, we successfully delivered over <strong>1,500+ orders with 97% Positive Reviews</strong> from our customers.</span></p>
