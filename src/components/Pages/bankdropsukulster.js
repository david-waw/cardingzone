    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.ProductName.includes('Ulster')).filter(name => name.category.includes('Bank')).filter(name => name.country.includes('united kingdom')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
