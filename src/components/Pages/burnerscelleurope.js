    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.category.includes('Cell')).filter(name => name.country.includes('europe')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
...
export default  BurnersCellEurope
