    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.category.includes('Bank')).filter(name => name.country.includes('belgium')).slice(pagesVisited, pagesVisited + itemsPerPage).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
