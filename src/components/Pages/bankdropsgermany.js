    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.category.includes('Bank')).filter(name => name.country.includes('germany')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
