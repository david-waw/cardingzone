    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.ProductName.includes('26')).filter(name => name.category.includes('Bank')).filter(name => name.country.includes('netherlands')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
