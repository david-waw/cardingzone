    ...
    return (
        ...
        <>
            ...
            <div className='productsContainer'>
                ...
                { product.filter(name => name.ProductName.includes('BTC')).filter(name => name.category.includes('BTC')).filter(name => name.country.includes('worldwide')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
