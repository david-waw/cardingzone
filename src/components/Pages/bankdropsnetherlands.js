            ...
            <div className="Shop">
                ...
                <div className='wrap'>
                    <div className='productsContainer'>
                        ...
                        {product.filter(name => name.category.includes('Bank')).filter(name => name.country.includes('netherlands')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
...
export default BankNetherlands