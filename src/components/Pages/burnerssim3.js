            ...
            <div className="Shop">
                ...
                <div className='wrap'>
                    <div className='productsContainer'>
                        ...
                        {product.filter(name => name.category.includes('Sim')).filter(name => name.country.includes('united states')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
