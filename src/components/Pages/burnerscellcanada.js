            ...
            <div className="Shop">
                ...
                <div className='wrap'>
                    <div className='productsContainer'>
                        ...
                        {product.filter(name => name.category.includes('Cell')).filter(name => name.country.includes('canada')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
...
export default BurnersCellCanada
