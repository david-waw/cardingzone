            ...
            <div className="Shop">
                ...
                <div className='wrap'>
                    <div className='productsContainer'>
                        ...
                        {product.filter(name => name.ProductName.includes('ulster')).filter(name => name.category.includes('Bank')).filter(name => name.country.includes('ireland')).slice(pagesVisited, pagesVisited + itemsPerPage).map(category => (
