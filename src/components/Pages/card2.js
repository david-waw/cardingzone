        ...
        <>
            ...
            <div className='productsContainer'>
                {product.length === 0 && <div>slow internet...no products to display</div>}
                        {product.filter(name => name.category.includes('CardProducts'))
                            .filter(name => name.country.includes('worldwide'))
...
export default  CardProductsWorldwide
